...
- 依据 Spec: [docs/features/ggtest-core/ggtest-core-runner-sqlite/spec.md](./spec.md)
- 依据 Design: [docs/features/ggtest-core/ggtest-core-runner-sqlite/design.md](./design.md)
- 路径等级: full
...
- `README.md`（更新）
- `docs/features/ggtest-core/ggtest-core-runner-sqlite/dev-notes.md`（Developer 实施后新增）
