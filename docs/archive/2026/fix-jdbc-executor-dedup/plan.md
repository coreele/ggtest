...
| `docs/features/fix-jdbc-executor-dedup/dev-notes.md` | **新增**：Developer 验证记录 |
| `docs/standards/code-audit-register.md` | 可选：CA-001 → `resolved`（QA Pass 后） |
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `docs/features/fix-jdbc-executor-dedup/dev-notes.md`（验证命令与结果）；共享类 Javadoc 简述职责 |
