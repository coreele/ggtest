...
依据：`docs/manager/fix-shared-defaults.md`；`docs/audit/2026-07-26-src.md`。
...
`docs/standards/code-audit-register.md`：CA-004、CA-005 → `resolved`，注明权威落点。  
...
| T3 | `src/`（只读） |
| T4 | Maven 套件；`docs/features/fix-shared-defaults/dev-notes.md` |
| T5 | `docs/standards/code-audit-register.md` |
