...
- 依据 Spec: [docs/features/ggtest-core/ggtest-core-cli-corpus/spec.md](./spec.md)
...
- `README.md`；`docs/features/ggtest-core/ggtest-core-cli-corpus/dev-notes.md`（Developer 实施后）
