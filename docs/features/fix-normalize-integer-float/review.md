...
- 依据：[`plan.md`](./plan.md)（approved；A1–A5）、[`dev-notes.md`](./dev-notes.md)；归档 [`ggtest-core-normalize/spec.md`](../../archive/2026/ggtest-core/ggtest-core-normalize/spec.md)（I：`%d`；无法解释 → `0`）；`documentation.md` / `quality.md` / `security.md` / `git.md`
...
- 工作区同在、不计入本项实现：`pom.xml`（compiler pin）、`docs/manager/*`、`STATUS.md`、未跟踪 `sqllogictest/`
