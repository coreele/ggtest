...
- 依据：`spec.md` / `plan.md`（均冻结）、`dev-notes.md`、`docs/manager/feat-cli-halt.md`；`documentation.md` / `quality.md` / `security.md` / `git.md`
...
- 排除：`docs/manager/*`、`STATUS.md` 属 Manager，不计入实现验收
