...
| `docs/features/chore-maven-compiler-release/plan.md` | 未跟踪 | 允许 |
| `docs/features/chore-maven-compiler-release/dev-notes.md` | 未跟踪 | 允许 |
| `docs/features/chore-maven-compiler-release/qa-report.md` | 本报告（未跟踪） | 允许 |
| `docs/manager/*` | 已改/未跟踪 | 非实现范围（可忽略） |
| `src/**` | 无变更 | 符合禁止项 |
