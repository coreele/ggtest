...
| feat-cli-halt | feat-cli-halt | CLI `--halt`：首个错误即停止（对齐官方 sqllogictest） | planned | standard | required | Developer 实施 T1-T8（先切源分支 feat-cli-halt） | [docs/features/feat-cli-halt/](../features/feat-cli-halt/) |
