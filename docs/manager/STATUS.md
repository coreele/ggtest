...
| | cli-corpus | CLI、统计、退出码、官方语料硬验收 | developing | full | required | Developer 修复 DEF-CLI-001；随后重新 Review 与 QA | [ggtest-core-cli-corpus/](../features/ggtest-core/ggtest-core-cli-corpus/) |
