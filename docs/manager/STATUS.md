...
| | cli-corpus | CLI、统计、退出码、官方语料硬验收 | developing | full | required | Developer TDD T1–T6（ggtest-core-cli-corpus → main） | [ggtest-core-cli-corpus/](../features/ggtest-core/ggtest-core-cli-corpus/) |
