...
| | cli-corpus | CLI、统计、退出码、官方语料硬验收 | qa | full | required | 调度 QA 验收（硬验收待语料；Review Approve @ 466c6f1） | [ggtest-core-cli-corpus/](../features/ggtest-core/ggtest-core-cli-corpus/) |
