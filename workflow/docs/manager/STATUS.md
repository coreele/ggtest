...
|---|---|---|---|---|---|---|---|
| sync-vs-slt-grammar | sync-vs-slt-grammar | vs-slt 插件高亮同步当前 SLT 语法 | done | standard | skipped | — | [workflow/docs/features/sync-vs-slt-grammar/](../features/sync-vs-slt-grammar/) |
...
| fix-ca019-cli-dash-values | fix-ca019-cli-dash-values | CLI 允许以 `-` 开头的值（CA-019） | done | fast | skipped | — | [workflow/docs/features/fix-ca019-cli-dash-values/](../features/fix-ca019-cli-dash-values/) |
...
| fix-ca023-prepare-conn-leak | fix-ca023-prepare-conn-leak | FileRunner prepare 失败连接泄漏（CA-023） | developing | fast | skipped | Reviewer | [workflow/docs/features/fix-ca023-prepare-conn-leak/](../features/fix-ca023-prepare-conn-leak/) |
