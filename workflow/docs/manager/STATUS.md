...
|---|---|---|---|---|---|---|---|
| sync-vs-slt-grammar | sync-vs-slt-grammar | vs-slt 插件高亮同步当前 SLT 语法 | planning | standard | skipped | Planner（进行中） | [workflow/docs/features/sync-vs-slt-grammar/](../features/sync-vs-slt-grammar/) |
