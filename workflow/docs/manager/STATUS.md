...
| add-parallel-execution | add-parallel-execution | `--parallel <N>` 并行执行独立文件 | planned | standard | required | Developer | [workflow/docs/features/add-parallel-execution/](../features/add-parallel-execution/) |
