...
|---|---|---|---|---|---|---|---|
| sync-vs-slt-grammar | sync-vs-slt-grammar | vs-slt 插件高亮同步当前 SLT 语法 | reviewing | standard | skipped | Reviewer | [workflow/docs/features/sync-vs-slt-grammar/](../features/sync-vs-slt-grammar/) |
