...
| add-parallel-execution | add-parallel-execution | `--parallel <N>` 并行执行独立文件 | speccing | standard | required | Analyst | [workflow/docs/features/add-parallel-execution/](../features/add-parallel-execution/) |
