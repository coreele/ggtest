...
> 未拆分：产物同目录（`spec.md` / `plan.md` / `review.md` / `qa-report.md`）。
...
|---|---|---|---|---|---|---|---|
| feat-statement-error-msg | standard | feat-statement-error-msg | [spec.md](spec.md) | required | not-required | skipped | required |
