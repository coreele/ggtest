...
> **前置条件**：工作项 [`workflow/docs/manager/feat-override-results.md`](../../manager/feat-override-results.md)；CLI/报告/退出码基线 [`workflow/docs/archive/2026/feat-cli-halt/spec.md`](../../archive/2026/feat-cli-halt/spec.md)；比对/失败来源 `runner/SqlLogicTestRunner.java`、`normalize/ResultComparer.java`；解析与记录结构 `parser/SqlLogicTestParser.java`、`model/QueryRecord.java`、`model/StatementRecord.java`、`model/SourceLocation.java`。
