...
- 依据 Spec: [workflow/archive/2026/ggtest-core/ggtest-core-runner-sqlite/spec.md](./spec.md)
- 依据 Design: [workflow/archive/2026/ggtest-core/ggtest-core-runner-sqlite/design.md](./design.md)
- 路径等级: full
...
- `README.md`（更新）
- `workflow/archive/2026/ggtest-core/ggtest-core-runner-sqlite/dev-notes.md`（Developer 实施后新增）
