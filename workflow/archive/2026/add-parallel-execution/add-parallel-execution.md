# 工作项: add-parallel-execution

描述: `--parallel <N>` 并行执行独立 .slt 文件（大语料加速）
目标分支: main
源分支: add-parallel-execution
基线提交: a6c8719bc48099cf772a6bd1807876dd4577259c
文档影响: README（en + zh）新增 `--parallel` 选项与并行语义说明；用户文档

> **本文件须保存为 `workflow/archive/2026/add-parallel-execution/add-parallel-execution.md`**，文件名与目录同名。
> 流程定义见 `workflow/WORKFLOW.md`；看板见 `workflow/STATUS.md`。
> 本工作项的全部产物平铺在 `workflow/archive/2026/add-parallel-execution/`，无子目录、无版本后缀。
