...
描述: README.md + README.zh-CN.md 同步当前语法：separator=、timeout=、conn=、--help
目标分支: main
源分支: sync-readme
基线提交: a6c8719bc48099cf772a6bd1807876dd4577259c
文档影响: 

> **本文件须保存为 `workflow/archive/2026/sync-readme/sync-readme.md`**，文件名与目录同名。
> 流程定义见 `workflow/WORKFLOW.md`；看板见 `workflow/STATUS.md`。
> 本工作项的全部产物平铺在 `workflow/archive/2026/sync-readme/`，无子目录、无版本后缀。
