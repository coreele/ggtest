...
- 依据 Spec: [workflow/archive/2026/ggtest-core/ggtest-core-cli-corpus/spec.md](./spec.md)
...
- `README.md`；`workflow/archive/2026/ggtest-core/ggtest-core-cli-corpus/dev-notes.md`（Developer 实施后）
