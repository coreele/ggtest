...
| 依据 | [`spec.md`](./spec.md)、[`design.md`](./design.md)、[`plan.md`](./plan.md)、[`dev-notes.md`](./dev-notes.md)；`workflow/archive/2026/ggtest-pg/ggtest-pg.md`；`workflow/agents/standards/{documentation,quality,security,git}.md` |
...
| 依据 | [`qa-report.md`](./qa-report.md) 轮次 2（DEF-PG-001 / DEF-PG-002）；[`dev-notes.md`](./dev-notes.md) 修复回执；[`spec.md`](./spec.md)、[`plan.md`](./plan.md)；`workflow/agents/standards/{documentation,quality,security,git}.md` |
...
| 依据 | `workflow/archive/2026/ggtest-pg/ggtest-pg.md`（DEF-PG-003 / 方案 A）；[`qa-report.md`](./qa-report.md)；[`dev-notes.md`](./dev-notes.md)；既有 Spec/Design/Plan（**无**合同变更）；`workflow/agents/standards/{documentation,quality,security,git}.md` |
