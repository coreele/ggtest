...
> **前置条件**：工作项 [`workflow/archive/2026/ggtest-pg/ggtest-pg.md`](../../manager/ggtest-pg.md)；归档 [`workflow/archive/2026/ggtest-core/`](../../archive/2026/ggtest-core/)（runner-sqlite / cli-corpus）；`com.ggtest.db.DatabaseExecutor` 与 CLI `--engine`；[`workflow/agents/standards/security.md`](../../standards/security.md)。
