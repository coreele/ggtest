...
- `workflow/agents/standards/git.md`（仅 Git 工作区）
- `workflow/agents/standards/quality.md`
- `workflow/agents/standards/security.md`（N/A：纯语法高亮配置文件，无敏感信息、依赖、认证授权或数据流变更）
...
运行 §验收与验证全部命令，结果记录到 `workflow/archive/2026/sync-vs-slt-grammar/dev-notes.md`（未拆分：feature 根目录）。
