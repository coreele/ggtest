...
- 依据 Spec: [workflow/archive/2026/improve-multi-failure-report/spec.md](./spec.md)（Spec approved）
...
| T3 | 无新路径 |
| T4 | `README.md`；`README.zh-CN.md`；`workflow/archive/2026/improve-multi-failure-report/dev-notes.md` |
