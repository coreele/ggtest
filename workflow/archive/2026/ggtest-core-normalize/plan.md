...
- 依据 Spec: [workflow/archive/2026/ggtest-core/ggtest-core-normalize/spec.md](./spec.md)
...
- `README.md`（更新）
- `workflow/archive/2026/ggtest-core/ggtest-core-normalize/dev-notes.md`（Developer 实施后新增）
