...
依据：`workflow/archive/2026/fix-shared-defaults/fix-shared-defaults.md`；`workflow/audit/2026-07-26-src.md`。
...
`workflow/audit/register.md`：CA-004、CA-005 → `resolved`，注明权威落点。  
...
| T3 | `src/`（只读） |
| T4 | Maven 套件；`workflow/archive/2026/fix-shared-defaults/dev-notes.md` |
| T5 | `workflow/audit/register.md` |
