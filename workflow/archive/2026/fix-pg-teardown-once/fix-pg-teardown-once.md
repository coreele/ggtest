# 工作项: fix-pg-teardown-once

描述: 审计 Tech Debt Low — PG teardown：try 内 hardFailure 时 finally 可能二次 DROP → 统一失败路径，避免双 teardown。来源：`workflow/audit/2026-07-26-src.md`。
目标分支: main
源分支: fix-pg-teardown-once
基线提交: a6c8719bc48099cf772a6bd1807876dd4577259c
文档影响: workflow/archive/2026/fix-pg-teardown-once/；登记册 CA-006

> **本文件须保存为 `workflow/archive/2026/fix-pg-teardown-once/fix-pg-teardown-once.md`**，文件名与目录同名。
> 流程定义见 `workflow/WORKFLOW.md`；看板见 `workflow/STATUS.md`。
> 本工作项的全部产物平铺在 `workflow/archive/2026/fix-pg-teardown-once/`，无子目录、无版本后缀。
