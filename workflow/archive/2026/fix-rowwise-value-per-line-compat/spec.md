...
> **前置条件**：工作项 [`workflow/archive/2026/fix-rowwise-value-per-line-compat/fix-rowwise-value-per-line-compat.md`](../../manager/fix-rowwise-value-per-line-compat.md)；只读参考归档 [`workflow/archive/2026/ggtest-rowwise-expected/spec.md`](../../archive/2026/ggtest-rowwise-expected/spec.md)（本 Spec **有意取代**其合同）。
