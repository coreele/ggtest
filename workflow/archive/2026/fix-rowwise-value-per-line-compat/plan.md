...
- 依据 Spec: [workflow/archive/2026/fix-rowwise-value-per-line-compat/spec.md](./spec.md)（required，已满足；合同由用户 2026-07-26 逐条拍板）
...
- 关联工作项: [`workflow/archive/2026/fix-rowwise-value-per-line-compat/fix-rowwise-value-per-line-compat.md`](../../manager/fix-rowwise-value-per-line-compat.md)
...
| T7 | Maven 套件；`workflow/archive/2026/fix-rowwise-value-per-line-compat/dev-notes.md` |
