...
| 依据 | [`spec.md`](./spec.md)（OQ-1 = 移除）、[`plan.md`](./plan.md)、[`dev-notes.md`](./dev-notes.md)；`workflow/archive/2026/fix-rowwise-value-per-line-compat/fix-rowwise-value-per-line-compat.md`；`workflow/agents/standards/{documentation,quality,security,git}.md` |
