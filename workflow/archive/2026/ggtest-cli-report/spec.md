...
> **前置条件**：工作项 [`workflow/archive/2026/ggtest-cli-report/ggtest-cli-report.md`](../../manager/ggtest-cli-report.md)（权威决议 Q-R1…Q-R8）；归档 [`workflow/archive/2026/ggtest-core/ggtest-core-cli-corpus/spec.md`](../../archive/2026/ggtest-core/ggtest-core-cli-corpus/spec.md)（纯文本；失败须含文件、行号、SQL 首行、失败原因）；基线 `CliSession`、`ResultComparer#buildDiffSummary`。
