...
| 依据 | [`spec.md`](./spec.md)、[`plan.md`](./plan.md)（均已批准）、[`dev-notes.md`](./dev-notes.md)；`workflow/archive/2026/ggtest-cli-report/ggtest-cli-report.md`（只读）；`workflow/agents/standards/{documentation,quality,security,git}.md` |
...
| 旁路噪声 | `architecture-overview`、`workflow/STATUS.md` 等非本项实现；合并前由 Manager 区分边界 |
