...
> **前置条件**：工作项 [`agents/docs/manager/feat-cli-halt.md`](../../manager/feat-cli-halt.md)；官方 `sqllogictest/src/sqllogictest.c`（`haltOnError`、`--halt`）；报告/退出码基线 [`agents/docs/archive/2026/ggtest-cli-report/spec.md`](../../archive/2026/ggtest-cli-report/spec.md)、README Exit codes。
