...
目标分支: main
文档影响: agents/features 产物已迁入本归档目录；默认不改 README 产品合同
...
> 本文件已归档为 `agents/docs/archive/2026/fix-normalize-integer-float/manager.md`；`agents/docs/manager/` 仅保留活跃工作项记录与 `STATUS.md`。
