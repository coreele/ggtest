...
- 依据 Spec: [agents/docs/features/ggtest-core/ggtest-core-cli-corpus/spec.md](./spec.md)
...
- `README.md`；`agents/docs/features/ggtest-core/ggtest-core-cli-corpus/dev-notes.md`（Developer 实施后）
