...
| 切片 | 未拆分；`agents/docs/features/refactor-cli-session-boundaries/` |
| 实现版本 | `86d94d0`（refactor）；基线含 T0 merge `9e01654`、docs `3e14256` |
| 审阅依据 | [design.md](./design.md)、[plan.md](./plan.md)、[dev-notes.md](./dev-notes.md)；`agents/docs/standards/{documentation,quality,security,git}.md` |
