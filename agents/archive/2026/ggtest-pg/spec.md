...
> **前置条件**：工作项 [`agents/manager/ggtest-pg.md`](../../manager/ggtest-pg.md)；归档 [`agents/archive/2026/ggtest-core/`](../../archive/2026/ggtest-core/)（runner-sqlite / cli-corpus）；`com.ggtest.db.DatabaseExecutor` 与 CLI `--engine`；[`agents/standards/security.md`](../../standards/security.md)。
