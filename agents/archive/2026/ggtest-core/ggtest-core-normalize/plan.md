...
- 依据 Spec: [agents/features/ggtest-core/ggtest-core-normalize/spec.md](./spec.md)
...
- `README.md`（更新）
- `agents/features/ggtest-core/ggtest-core-normalize/dev-notes.md`（Developer 实施后新增）
