...
| 依据 | 冻结 [`spec.md`](./spec.md)（保留 R1/R2，**已废止 R3**）；[`design.md`](./design.md) D1–D4；[`plan.md`](./plan.md) T1–T5；[`dev-notes.md`](./dev-notes.md)；`agents/standards/{documentation,quality,security,git}.md` |
