...
依据：`agents/manager/fix-shared-defaults.md`；`agents/audit/2026-07-26-src.md`。
...
`agents/standards/code-audit-register.md`：CA-004、CA-005 → `resolved`，注明权威落点。  
...
| T3 | `src/`（只读） |
| T4 | Maven 套件；`agents/features/fix-shared-defaults/dev-notes.md` |
| T5 | `agents/standards/code-audit-register.md` |
