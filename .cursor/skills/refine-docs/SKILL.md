---
name: refine-docs
description: Use when a spec.md, design.md, plan.md, dev-notes.md, review.md, or qa-report.md draft is complete before validation or handoff.
---

# refine-docs

精简 `spec.md`、`design.md`、`plan.md`、`dev-notes.md`、`review.md` 或 `qa-report.md`，保持语义与可验证性不变。
